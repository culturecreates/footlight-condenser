...
class Dsl::UrlResolverTest < ActiveSupport::TestCase
  test "extract returns normalized url for string input" do
    value = " https://example.com/events/1#tickets "

    assert_equal "https://example.com/events/1", Dsl::UrlResolver.extract(value)
  end
  ...
  test "extract returns first valid url from mixed array input" do
    ...
    assert_equal "https://first.example.com/path", Dsl::UrlResolver.extract(value)
  end

  test "extract returns nil for hash input" do
    value = { "url" => "https://example.com" }

    assert_nil Dsl::UrlResolver.extract(value)
  end

  test "extract returns first valid url from json string input" do
    value = "https://json.example.com/tickets#purchase".to_json

    assert_equal "https://json.example.com/tickets", Dsl::UrlResolver.extract(value)
  end
  ...
  test "extract returns nil for nil input" do
    assert_nil Dsl::UrlResolver.extract(nil)
  end
end
